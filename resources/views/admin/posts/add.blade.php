            ...
            <div class="col-lg-8 col-xlg-9 col-md-7">
                        <div class="card">
                            <div class="card-block">
                                ...
                                @endif
                                <form class="form-horizontal form-material" method="POST" enctype="multipart/form-data" action='{{url('admin/posts/doAdd')}}'>
                                    {!! csrf_field() !!}
                                    <div class="form-group">
                                        <label class="col-md-12">Name</label>
                                        <div class="col-md-12">
                                            <input required='true' type="text" placeholder="Post name" name='name' class="form-control form-control-line">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="example-email" class="col-md-12">Title</label>
                                        <div class="col-md-12">
                                            <input required='true' type="text" placeholder="Post title" class="form-control form-control-line" name="title" id="example-email">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input required='true' type="number" name='top' placeholder="1" class="form-control form-control-line">
                                        </div>
                                    </div>
                                    <div class="form-group">
