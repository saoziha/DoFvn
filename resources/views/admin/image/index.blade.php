   ...
   <div class="container-fluid">
        ...
        <div class="row page-titles">
            ...
            <div class="col-md-6 col-4 align-self-center">
                <a href="{{url('/admin/image/'.$id.'/add')}}" class="btn pull-right hidden-sm-down btn-success"> Add</a>
            </div>
        </div>
                            ...
                            <table id="myTable" class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <form action='{{url("admin/image")."/".$item->id."/edit"}}' method="POST">
                                                {!! csrf_field() !!}
                                            @if($item->status==1)
                                            ...
                                            <div id="editModal{{$item->id}}" class="modal fade" role="dialog">
                                                <div class="modal-dialog">
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <form class='form-horizontal form-material' enctype="multipart/form-data" action='{{url("admin/image")."/".$item->id."/edit"}}' method="POST">
                                                            {!! csrf_field() !!}
                                            ...
                                            <div id="delModal{{$item->id}}" class="modal fade" role="dialog">
                                                <div class="modal-dialog">
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            <form class='form-horizontal form-material' action='{{url("admin/image")."/".$item->id."/delete"}}' method="POST">
                                                                {!! csrf_field() !!}
